...
<div class="flex-1 mt-4 bg-base-100 pb-16">
    <div class="bg-base-200 w-[95%] max-w-screen-lg rounded-lg mx-auto flex flex-col">
        ...
        <div class="pl-6 pr-5 py-3 flex justify-between text-lg font-bold">
            ...
            <div class="inline right-0">
                ...
                {/if}
                <label for="class_members_modal" class="btn-ghost btn-tiny rounded-lg p-1"><i class="fa-solid fa-user-group fa-sm mx-1"></i></label>
                {#if role != "student"}
...
<Modal modalId="class_members_modal">
    <h3 class="font-bold text-lg mb-4 text-white">Class Members</h3> 
    <div class="w-full">
        ...
        <div class="flex items-center my-3 w-full">
            ...
            <div class="flex items-center">
                ...
                {#if member.role != "student"}
                    <div class="badge {member.role=="moderator" ? "badge-primary" : "badge-secondary"} ml-2">{member.role}</div>
                {/if}
...
<Modal modalId="change_display_name_modal" >
    <form action="?/changedisplayname" method="POST">
        ...
        <h3 class="font-bold text-lg mb-3 text-white">Change Display Name</h3>
...
<Modal modalId="change_role_modal">
    <form action="?/changerole" method="POST">
        ...
        <input name="new_role" value={change_role_selected} class="hidden">
        <input name="member_id" value={member_id_to_change_role} class="hidden">
    ...
    <form action="?/editclass" method="POST">
        <div class="form-control w-full">
            ...
            <div class="flex justify-between items-center mt-4 mb-2">
                ...
                <button type="submit" class="btn btn-accent w-32 mt-3">Save</button>
            </div>
